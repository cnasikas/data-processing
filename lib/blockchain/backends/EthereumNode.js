...
const DATA_CONTRACT_ADDRESS = DataStoreJSON.networks[NETWORK_ID].address
const PROOF_CONTRACT_ADDRESS = ProofStoreContract.networks[NETWORK_ID].address
...
module.exports = class EthereumNode extends Node {
  ...
  async init () {
    ...
    this.dataStoreInstance = this.dataStoreContract.at(DATA_CONTRACT_ADDRESS)
    this.proofStoreInstance = this.proofContract.at(PROOF_CONTRACT_ADDRESS)

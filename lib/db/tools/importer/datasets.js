...
const importDataSets = async (node) => {
  const datasets = [
    {
      hash: '9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08', // SHA256('test')
      name: 'Dataset #1',
      location: 'http://localhost:3003/datastore/9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08',
      category: 'Health',
  ...
  await importEntries(node, datasets, { ...options })
  console.log('[*] Done!')
}
